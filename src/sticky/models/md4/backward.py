...
# ==============================================================================
"""Backward model (classifier) used by MD4.

This file mirrors the upstream MD4 JAX `md4/models/backward.py` but adapts
imports to Sticky's module layout.
"""
...
from .networks import sharded_transformer
from .networks import transformer
from .networks import unet
from .networks import uvit
